...
\begin{tikzpicture}
	\begin{timeplot}{gSER (dB)}%[ymin=18, ymax=33, ytick={18, 24, 30}]
		...
		\addplot [style=resA2]
		table [col sep=comma, y=val] {figures/io_input/STFT/gSER_l__h__STFT__N_32__iSER_n15__Ly_10__err_0.csv};
		
		\addplot [style=resC1]
		table [col sep=comma, y=val] {figures/io_input/SSBT/gSER_l__h__SSBT__N_32__iSER_n15__Ly_1__err_0.csv};
		
		\addplot [style=resC2]
		table [col sep=comma, y=val] {figures/io_input/SSBT/gSER_l__h__SSBT__N_32__iSER_n15__Ly_10__err_0.csv};
	\end{timeplot}
\end{tikzpicture}
%	\caption{}
