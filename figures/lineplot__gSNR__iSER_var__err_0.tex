...
\begin{tikzpicture}
	\begin{snrplot}{gSNR (dB)}%[ymin=-13, ymax=-3, ytick={-12, -9, ..., -3}]
		...
		\addplot [style=resA2]
		table [col sep=comma, y=val] {figures/io_input/STFT/gSNR__h__STFT__N_32__iSER_var__Ly_16__err_0.csv};
		
		\addplot [style=resC1]
		table [col sep=comma, y=val] {figures/io_input/SSBT/gSNR__h__SSBT__N_32__iSER_var__Ly_1__err_0.csv};
		
		\addplot [style=resC2]
		table [col sep=comma, y=val] {figures/io_input/SSBT/gSNR__h__SSBT__N_32__iSER_var__Ly_16__err_0.csv};
	\end{snrplot}
\end{tikzpicture}
%	\caption{}
