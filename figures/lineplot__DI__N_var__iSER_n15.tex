...
\begin{tikzpicture}
	\begin{nbinsplot}{DI (dB)}%[ymin=-3, ymax=0.03, ytick={-3, -2, -1, 0}]
		...
		\addplot [mark=none, gray, dash pattern={on 3pt off 3pt}] coordinates {(32, 28.4075) (512, 28.4075)};
%		
		\addplot [mark=none, lightgray, dash pattern={on 0.5pt off 1pt}] coordinates {(32, 25.1168) (512, 25.1168)};
	\end{nbinsplot}
\end{tikzpicture}
%	\caption{}
