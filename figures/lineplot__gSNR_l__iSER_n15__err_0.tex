...
\begin{tikzpicture}
	\begin{timeplot}{gSNR (dB)}%[ymin=-15, ymax=-2]
		...
		\addplot [style=resA2]
		table [col sep=comma, y=val] {figures/io_input/STFT/gSNR_l__h__STFT__N_32__iSER_n15__Ly_16__err_0.csv};
		
		\addplot [style=resC1]
		table [col sep=comma, y=val] {figures/io_input/SSBT/gSNR_l__h__SSBT__N_32__iSER_n15__Ly_1__err_0.csv};
		
		\addplot [style=resC2]
		table [col sep=comma, y=val] {figures/io_input/SSBT/gSNR_l__h__SSBT__N_32__iSER_n15__Ly_16__err_0.csv};
	\end{timeplot}
\end{tikzpicture}
%	\caption{}
