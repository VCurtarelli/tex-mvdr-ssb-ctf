...
\begin{tikzpicture}
	\begin{nbinsplot}{gSNR (dB)}%[ymin=-3, ymax=0.03, ytick={-3, -2, -1, 0}]
		\addplot [style=resA1]
		table [col sep=comma, y=val] {figures/io_input/STFT/gSNR__h__STFT__N_var__iSER_n15__Ly_16__err_0__acc.csv};
		
		\addplot [style=resA2]
		table [col sep=comma, y=val] {figures/io_input/STFT/gSNR__h__STFT__N_var__iSER_n15__Ly_16__err_0__est.csv};
