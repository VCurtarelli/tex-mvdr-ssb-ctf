...
\begin{document}
	...
	%TODO: Trocar gSNR por NSRF			DONE
	
	%TODO: (IN SIMS) Change the interference signal source (and signal) to the new ones
	
	%TODO: Read papers MPDR
	%TODO: Read papers real-time MVDR/MPDR
	%TODO: Separate into two results:
		%TODO: Calibrated steerable MPDR
		%TODO: Real-time MPDR
