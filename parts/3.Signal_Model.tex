...
% are the narrowband gain in signal-to-noise ratio (SNR) and narrowband desired signal reduction factor (DSRF), respectively given by
%\begin{equation}
...
%\end{equation}
%with $L_Z$ being the number of windows of $Z[l,k]$; and the frequency-averaged SNR gain and DSRF, given by
%\begin{equation}
