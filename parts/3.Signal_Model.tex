...
We can use a time-frequency transform (in here the STFT or the SSBT, as exposed in \cref{sec:stft_and_ssbt}) with the CTF model \cite{ctf_model} to turn \cref{eq:sec3:time_model_relative} into
\begin{equation}
