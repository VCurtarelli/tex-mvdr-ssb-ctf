...
\begin{subgather}{eq:sec3:sample-stacking_bvDb_bvxb}
	\bvD[b]{m,k}^n = \begin{bmatrix}
		\he*{\bvd{m,k}^n} & 0 & \cdots & 0 \\
		0 & \he*{\bvd{m,k}^n} & \cdots & 0 \\
		\vdots & \vdots & \ddots & \vdots \\
		0 & 0 & \cdots & \he*{\bvd{m,k}^n}
...
\begin{equation}
	...
	X_{f,k}[l] = X_{1,k}[l]
\end{equation}
which is equivalent to requiring that each component of $X_{1,k}[l]$ is distortionlessly recovered. From \cref{eq:sec3:sample-stacking_bvDb_bvxb:subeq2}, we have that the desired signal on the current instant, $X_{1,k}^n[l]$, is the $(\Delta+1)$-th element of $\bvx[b]{1,k}^n[l]$. Therefore, our distortionless constraint can be written as
