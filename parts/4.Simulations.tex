...
We chose to use the gains in SER and SNR metrics rather than the more common ERLE and WNG \cite{wada_enhancement_2012} based on \textit{a priori} knowledge of distortion on the desired signal, and therefore the relative metrics become more faithfully representative of the results.
