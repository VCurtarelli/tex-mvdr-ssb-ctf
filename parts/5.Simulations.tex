...
Here, we now take the broadband average output for the beamformers, allowing us to compare them for different values of input SIR, for both $K = 32$ and $K = 64$.
