...
\begin{subgather}{eqs:sec2:calc_RTF_rft_expec}
	A_2'(f) = \frac{\expec{X_1(f) X_2(f)}}{\expec{X_1^2(f)}} \label{eq:sec2:calc_RTF_rft_expec:subeq1} \\
	A_2''(f) = \frac{\expec{X_1(\-f) X_2(f)}}{\expec{X_1^2(f)}} \label{eq:sec2:calc_RTF_rft_expec:subeq2}
\end{subgather}
...
\begin{subgather}{eqs:sec2:calc_RTF_rft_expec_generic}
	A_m'(f) = \frac{\expec{X_1(f) X_m(f)}}{\expec{X_1^2(f)}} \label{eqs:sec2:calc_RTF_rft_expec_generic:subeq1} \\
	A_m''(f) = \frac{\expec{X_1(\-f) X_m(f)}}{\expec{X_1^2(f)}} \label{eqs:sec2:calc_RTF_rft_expec_generic:subeq2} 
\end{subgather}
