...
\begin{thought}
	...
	\begin{subgather}
		...
		\end{split}
	\end{subgather}
	not being useful to solve this problem since they're dependent equations. Therefore, the best one can do is to get an under-determined system with $3$ equations and $4$ variables, which can have infinite solutions.
